...
export default function LeadFormModal({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        onSubmit({ name, phone, status, details: detail_items, address, company, email: email, id: id, needs: needs });
    };
                        ...
                        {items.map((item, index) => (
                            <div key={index} className="flex gap-2 items-center">
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        handleItemChange(index, "unit_price", parseRupiah(e.target.value))
                                    }
                                    required
                                />
                                <input
